const CACHE = 'mocergo-v3';
// Só cacheia assets externos (fontes, imagens CDN). NUNCA HTML/JS do próprio site.
...
self.addEventListener('fetch', e => {
  ...
  // HTML, JS, tudo do próprio site → SEMPRE rede (nunca cacheia)
